...
function computePrice(basePrice: string, storage?: StorageOption): string {
  ...
  const offset = storage?.priceSuffix
    ...
    : 0;
  const total  = base + (isNaN(offset) ? 0 : offset);
...
function MobileCard({
  ...
  return (
    <div className="flex flex-col overflow-hidden rounded-xl border border-gray-100 bg-white shadow-sm active:shadow-md transition-shadow duration-200">
                  ...
                  style={{
                    ...
                    boxShadow: isActive
                      ? `0 0 0 1.5px white, 0 0 0 2.5px ${
                          color.swatch === "#FFFFFF" || color.swatch === "#F5F6FA" ? "#aaa" : color.swatch
                        }`
                    ...
                    {isActive && (
                      ...
                      >
                        <Check
                          ...
                          style={{
                            color:
                              color.swatch === "#FFFFFF" || color.swatch === "#F5F5F5" || color.swatch === "#F5F6FA"
                                ? "#555"
                                : "white",
                          }}
                        />
      ...
      <div className="flex items-center justify-between gap-1 px-2.5 py-2.5">
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1 text-[13px] font-black text-gray-900">{displayPrice}</p>
        </div>
...
export default function ProductCard(props: ProductCardProps) {
  ...
  // ── Mobile / tablet: render compact card ──────────────────────────────────
  // The lg: breakpoint wrapper in ProductGridSection controls column count.
  // We rely on a CSS trick: render BOTH and show/hide via responsive classes.
  ...
  return (
    <>
      ...
      {/* ════════ DESKTOP  (hidden below lg) — UNCHANGED ════════ */}
      <div
      ...
      >
        ...
        >
          ...
          {/* ── FRONT FACE ─────────────────────────────────────────────── */}
          <div
            className="relative flex h-full flex-col overflow-hidden rounded-md border border-gray-100 bg-white transition-shadow duration-300 group-hover:shadow-[0_8px_32px_rgba(0,102,255,0.10)]"
          ...
          >
            ...
            <div className="flex flex-1 flex-col gap-1.5 p-4">
              ...
              <div className="mt-auto pt-3">
                ...
                >
                  <motion.div
                    animate={{ opacity: cardHovered && !addedToCart ? 0.45 : 1 }}
                    transition={{ duration: 0.2 }}
                    className="flex items-baseline gap-2"
                  >
                    <span className="text-[17px] font-bold text-gray-900">{displayPrice}</span>
                  </motion.div>
